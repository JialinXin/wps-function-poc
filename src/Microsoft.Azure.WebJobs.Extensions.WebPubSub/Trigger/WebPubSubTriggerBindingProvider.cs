...
namespace Microsoft.Azure.WebJobs.Extensions.WebPubSub
{
    internal class WebPubSubTriggerBindingProvider : ITriggerBindingProvider
    {
        ...
        public WebPubSubTriggerBindingProvider(IWebPubSubTriggerDispatcher dispatcher, WebPubSubOptions options, INameResolver nameResolver, Exception webhookException)
        {
        ...
        public Task<ITriggerBinding> TryCreateAsync(TriggerBindingProviderContext context)
        {
            ...
            return Task.FromResult<ITriggerBinding>(new WebPubSubTriggerBinding(parameterInfo, attribute, _options, _dispatcher, _nameResolver));
        }
    }
}
