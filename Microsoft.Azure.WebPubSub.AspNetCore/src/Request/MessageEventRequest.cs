...
namespace Microsoft.Azure.WebPubSub.AspNetCore
{
    ...
    public sealed class MessageEventRequest : WebPubSubRequest
    {
        ...
        public MessageResponse CreateResponse(string message, MessageDataType dataType = MessageDataType.Text)
        {
        ...
        /// <returns>A <see cref="MessageResponse"/> to return caller.</returns>
        public MessageResponse CreateResponse(BinaryData message, MessageDataType dataType)
        {
            return new MessageResponse(message, dataType);
        }
